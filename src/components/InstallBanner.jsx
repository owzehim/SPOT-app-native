...
import { X, DeviceMobile, Export, PlusSquare } from 'phosphor-react-native'

const STORAGE_KEY = "spot_install_banner_dismissed";
    ...
    <div style={styles.overlay}>
      <div style={styles.banner}>
        ...
        <div style={styles.iconWrapper}>
          <img src="/icon-192.png" alt="SPOT" style={styles.icon} />
        </div>
