    ...
    <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', alignItems: 'center', padding: 16 }}>
      <View style={{ width: '100%', maxWidth: 384 }}>
        ...
        <View style={{ alignItems: 'center', marginBottom: 32 }}>
          ...
          <Text style={{ fontSize: 20, fontWeight: 'bold', color: '#111827', marginTop: 16, marginBottom: 8 }}>
            UvA-IN Membership
          </Text>
        ...
        <View style={{ gap: 12, marginBottom: 32 }}>
          {[
            { Icon: ForkKnife, color: '#f97316', title: '제휴 레스토랑 / 카페 할인', desc: '암스테르담 내 제휴 장소에서 멤버십 할인 혜택' },
            { Icon: Calendar, color: '#3b82f6', title: '학생회 이벤트 우선 참가', desc: '이벤트 참가비 무료 및 할인 혜택' },
            { Icon: Users, color: '#22c55e', title: 'UvA 한인 네트워크', desc: '암스테르담 한인 학생 커뮤니티 참여' },
            ...
            <View key={title} style={{
              ...
              <View style={{ flex: 1 }}>
                <Text style={{ fontWeight: '600', color: '#111827', fontSize: 14, marginBottom: 2 }}>{title}</Text>
